...
export default function StudentResultPage() {
      ...
      <>
        ...
        <div className="flex items-center justify-center min-h-[60vh] p-6">
          <div className="text-center">
            <p className="text-lg font-semibold text-[#1A202C] mb-2">Unavailable</p>
  ...
  return (
    <>
      <TopBar title="Paper" backHref="/student/assignments" />
      <PaperView paper={generatedPaper} assignmentId={id} variant="student" />
    </>
  );
}
